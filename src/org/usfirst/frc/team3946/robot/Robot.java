...
import org.usfirst.frc.team3946.robot.ThreadedPi.DataKeeper;
...
//import org.usfirst.vision.VisionException;
...
//		}
	...
	public void autonomousInit() {
		...
		case "Position One":
		default:
			autonomousCommand = new AutoTravel(10, 60);
			break;
		case "Position Two":
			autonomousCommand = new AutoTravel(10, 30);
			break;
		case "Position Three":
			autonomousCommand = new AutoTravel(10, 15);
			break;
		case "Position Four":
			autonomousCommand = new AutoTravel(10, 5);
			break;
		case "Position Five":
			autonomousCommand = new AutoTravel(10, -30);
			break;
